...
export default function Vista({url, onDeleteFromPage=null, onUpdated=null, item=null, compId=0})
{
    ...
    return(
        <div className="inner-vista-container">
            {isAdmin &&(
                  <button className="inner-vista-container-on-delete-from-page" onClick={() => onDeleteFromPage(compId)}>
            ...
            {isAdmin && (
                    <button className="inner-vista-on-update-btn" onClick={() => onUpdated(item)}>
                        <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
